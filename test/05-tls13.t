...
for my $t (@tests) {
    ...
    if (not $t->{use_auth} or $t->{expect_auth_success}) {
        ...
        # There is currently no way to get proper client certificate for infotecs
        # servers. So expected behavior is as follows:
        # * mTLS connection succeeds
        # * Server responses is "400 The SSL certificate error" and closes connection
