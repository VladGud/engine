...
const OSSL_ALGORITHM GOST_prov_encoder[] = {
    ...
    ENCODER(GOST_SIGALG_2012_256A, gost2012_256, pem, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_256B, gost2012_256, pem, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_256C, gost2012_256, pem, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_256D, gost2012_256, pem, PrivateKeyInfo),
    ENCODER(ALG_NAME_GOST2012_256, gost2012_256, der, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_256A, gost2012_256, der, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_256B, gost2012_256, der, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_256C, gost2012_256, der, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_256D, gost2012_256, der, PrivateKeyInfo),
    ENCODER(ALG_NAME_GOST2012_256, gost2012_256, pem, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_256A, gost2012_256, pem, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_256B, gost2012_256, pem, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_256C, gost2012_256, pem, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_256D, gost2012_256, pem, SubjectPublicKeyInfo),
    ENCODER(ALG_NAME_GOST2012_256, gost2012_256, der, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_256A, gost2012_256, der, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_256B, gost2012_256, der, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_256C, gost2012_256, der, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_256D, gost2012_256, der, SubjectPublicKeyInfo),
    ENCODER_TEXT(ALG_NAME_GOST2012_256, gost2012_256, text),
    ENCODER_TEXT(GOST_SIGALG_2012_256A, gost2012_256, text),
    ENCODER_TEXT(GOST_SIGALG_2012_256B, gost2012_256, text),
    ENCODER_TEXT(GOST_SIGALG_2012_256C, gost2012_256, text),
    ENCODER_TEXT(GOST_SIGALG_2012_256D, gost2012_256, text),
    ENCODER(ALG_NAME_GOST2012_512, gost2012_512, pem, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_512A, gost2012_512, pem, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_512B, gost2012_512, pem, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_512C, gost2012_512, pem, PrivateKeyInfo),
    ENCODER(ALG_NAME_GOST2012_512, gost2012_512, der, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_512A, gost2012_512, der, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_512B, gost2012_512, der, PrivateKeyInfo),
    ENCODER(GOST_SIGALG_2012_512C, gost2012_512, der, PrivateKeyInfo),
    ENCODER(ALG_NAME_GOST2012_512, gost2012_512, pem, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_512A, gost2012_512, pem, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_512B, gost2012_512, pem, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_512C, gost2012_512, pem, SubjectPublicKeyInfo),
    ENCODER(ALG_NAME_GOST2012_512, gost2012_512, der, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_512A, gost2012_512, der, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_512B, gost2012_512, der, SubjectPublicKeyInfo),
    ENCODER(GOST_SIGALG_2012_512C, gost2012_512, der, SubjectPublicKeyInfo),
    ENCODER_TEXT(ALG_NAME_GOST2012_512, gost2012_512, text),
    ENCODER_TEXT(GOST_SIGALG_2012_512A, gost2012_512, text),
    ENCODER_TEXT(GOST_SIGALG_2012_512B, gost2012_512, text),
    ENCODER_TEXT(GOST_SIGALG_2012_512C, gost2012_512, text),
    { NULL, NULL, NULL }
};
